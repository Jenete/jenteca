import { getFirestore, collection, getDocs, doc,query, deleteDoc, setDoc, where } from 'https://www.gstatic.com/firebasejs/9.8.3/firebase-firestore.js';
...
async function getAllFromTable(table) {
  ...
  citySnapshot.docs.map(doc => users.push(doc.data()));
  return users;
} 
